 ...
 * 自定义播放器
 */
public class VideoPlayerPlus extends GSYVideoPlayer {
    ...
    public VideoPlayerPlus(Context context, Boolean fullFlag) {
    ...
    public VideoPlayerPlus(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void startPlayLogic() {
        if (mVideoAllCallBack != null) {
            mVideoAllCallBack.onClickStartThumb(mOriginUrl, mTitle, VideoPlayerPlus.this);
        }
        prepareVideo();
    ...
    protected void showVolumeDialog(float deltaY, int volumePercent) {
        if (mVolumeDialog == null) {
            View localView = View.inflate(getActivityContext(), R.layout.dialog_video_volume, null);
    ...
    protected void showBrightnessDialog(float percent) {
        if (mBrightnessDialog == null) {
            View localView = View.inflate(getActivityContext(), R.layout.dialog_video_brightness, null);
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            VideoPlayerPlus gsyVideoPlayer = (VideoPlayerPlus) gsyBaseVideoPlayer;
            gsyVideoPlayer.setStandardVideoAllCallBack(mVideoAllCallBack);
     ...
     * 全屏的UI逻辑
     */
    private void initFullUI(VideoPlayerPlus LQRBiliBiliPlayer) {
        if (mBottomProgressDrawable != null) {
    ...
    public void setStandardVideoAllCallBack(VideoAllCallBack videoAllCallBack) {
