 ...
 */
public class VideoPlayerOptionBuilder {
     ...
     */
    public VideoPlayerOptionBuilder setShowFullAnimation(boolean showFullAnimation) {
     ...
     * 设置循环
     */
    public VideoPlayerOptionBuilder setLooping(boolean looping) {
     ...
     * 设置播放过程中的回调
     */
    public VideoPlayerOptionBuilder setVideoAllCallBack(VideoAllCallBack videoAllCallBack) {
     ...
     * 是否开启自动旋转
     */
    public VideoPlayerOptionBuilder setRotateViewAuto(boolean rotateViewAuto) {
     ...
     * 播放速度
     */
    public VideoPlayerOptionBuilder setLockLand(boolean lockLand) {
     ...
     * 变声不变调
     */
    public VideoPlayerOptionBuilder setSoundTouch(boolean soundTouch) {
     ...
     * 全屏隐藏虚拟按键，默认打开
     */
    public VideoPlayerOptionBuilder setHideKey(boolean hideKey) {
     ...
     * 默认true
     */
    public VideoPlayerOptionBuilder setIsTouchWidget(boolean isTouchWiget) {
     ...
     * 是否需要显示流量提示,默认true
     */
    public VideoPlayerOptionBuilder setNeedShowWifiTip(boolean needShowWifiTip) {
     ...
     * 不设置使用默认
     */
    public VideoPlayerOptionBuilder setEnlargeImageRes(int enlargeImageRes) {
     ...
     * 不设置使用默认
     */
    public VideoPlayerOptionBuilder setShrinkImageRes(int mShrinkImageRes) {
     ...
     */
    public VideoPlayerOptionBuilder setShowPauseCover(boolean showPauseCover) {
     ...
     */
    public VideoPlayerOptionBuilder setSeekRatio(float seekRatio) {
        if (seekRatio < 0) {
            return this;
        }
     ...
     */
    public VideoPlayerOptionBuilder setRotateWithSystem(boolean rotateWithSystem) {
     ...
     */
    public VideoPlayerOptionBuilder setPlayTag(String playTag) {
     ...
     * 设置播放位置防止错位
     */
    public VideoPlayerOptionBuilder setPlayPosition(int playPosition) {
     ...
     */
    public VideoPlayerOptionBuilder setSeekOnStart(long seekOnStart) {
     ...
     * 播放url
     */
    public VideoPlayerOptionBuilder setUrl(String url) {
        this.mUrl = url;
        return this;
    }
     ...
     * 视频title
     */
    public VideoPlayerOptionBuilder setVideoTitle(String videoTitle) {
     ...
     * 是否边缓存，m3u8等无效
     */
    public VideoPlayerOptionBuilder setCacheWithPlay(boolean cacheWithPlay) {
     ...
     */
    public VideoPlayerOptionBuilder setCachePath(File cachePath) {
     ...
     * 设置请求的头信息
     */
    public VideoPlayerOptionBuilder setMapHeadData(Map<String, String> mapHeadData) {
        this.mMapHeadData = mapHeadData;
        return this;
    }

    public VideoPlayerOptionBuilder setStandardVideoAllCallBack(StandardVideoAllCallBack standardVideoAllCallBack) {
        mStandardVideoAllCallBack = standardVideoAllCallBack;
        return this;
    }
     ...
     * 设置封面
     */
    public VideoPlayerOptionBuilder setThumbImageView(View view) {
     ...
     * 底部进度条(弹出的)
     */
    public VideoPlayerOptionBuilder setBottomShowProgressBarDrawable(Drawable drawable, Drawable thumb) {
     ...
     * 底部进度条(非弹出)
     */
    public VideoPlayerOptionBuilder setBottomProgressBarDrawable(Drawable drawable) {
     ...
     * 声音进度条
     */
    public VideoPlayerOptionBuilder setDialogVolumeProgressBar(Drawable drawable) {
     ...
     * 中间进度条字体颜色
     */
    public VideoPlayerOptionBuilder setDialogProgressColor(int highLightColor, int normalColor) {
     ...
     * 是否点击封面可以播放
     */
    public VideoPlayerOptionBuilder setThumbPlay(boolean thumbPlay) {
     ...
     */
    public VideoPlayerOptionBuilder setNeedLockFull(boolean needLockFull) {
     ...
     * 锁屏点击
     */
    public VideoPlayerOptionBuilder setLockClickListener(LockClickListener lockClickListener) {
     ...
     */
    public VideoPlayerOptionBuilder setDismissControlTime(int dismissControlTime) {
     ...
     * 设置滤镜效果
     */
    public VideoPlayerOptionBuilder setEffectFilter(GSYVideoGLView.ShaderInterface effectFilter) {
        this.mEffectFilter = effectFilter;
        return this;
    }

    public void build(VideoPlayerPlus playerPlus) {
        if (mStandardVideoAllCallBack != null) {
            playerPlus.setStandardVideoAllCallBack(mStandardVideoAllCallBack);
        }
        if (mBottomShowProgressDrawable != null && mBottomShowProgressThumbDrawable != null) {
            playerPlus.setBottomShowProgressBarDrawable(mBottomShowProgressDrawable, mBottomShowProgressThumbDrawable);
        }

        if (mBottomProgressDrawable != null) {
            playerPlus.setBottomProgressBarDrawable(mBottomProgressDrawable);
        }

        if (mVolumeProgressDrawable != null) {
            playerPlus.setDialogVolumeProgressBar(mVolumeProgressDrawable);
        }

        if (mDialogProgressHighLightColor > 0 && mDialogProgressNormalColor > 0) {
            playerPlus.setDialogProgressColor(mDialogProgressHighLightColor, mDialogProgressNormalColor);
        }

        build((GSYBaseVideoPlayer) playerPlus);
    }
